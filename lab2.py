...
def compare_best_improvements():
    
    list = []
    
    for i in range(100):
        biVal, biWeight, biSoln = best_improvement_hill_climb()
        list.append(biVal)
    
    return list

def compare_first_improvements():
    
    list = []
    
    for i in range(100):
        fiVal, fiWeight, fiSoln = first_improvement_hill_climb()
        list.append(fiVal)
    
    return list

# biList = [100]
# biList =  compare_best_improvements()
# print "List: ", biList
# 
# fiList = [100]
# fiList =  compare_first_improvements()
# print "List: ", fiList
